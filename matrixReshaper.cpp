...
void stdToSpiralUfast64 (uint_fast64_t xSize, uint_fast64_t ySize, uint_fast64_t ** ogPtr, bool isCCW, bool startAtTop, bool startAtLeft){
...
void stdToCCWSpiralBool4 (uint_fast64_t xySize, bool ** ogPtr) {
	...
	// starting point
	currentX = static_cast<uint_fast64_t>(floor(static_cast<long double>(xySize) / 2.0));
	currentY = static_cast<uint_fast64_t>(floor(static_cast<long double>(xySize) / 2.0));
